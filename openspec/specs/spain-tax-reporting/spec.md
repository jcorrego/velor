...
The system SHALL provide a foreign asset dashboard aligned with Modelo 720 thresholds.

#### Scenario: View foreign asset thresholds
- **WHEN** a user opens the Modelo 720 dashboard
- **THEN** the system SHALL display asset totals by category and threshold status
