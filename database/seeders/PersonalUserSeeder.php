...
class PersonalUserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $basicCategories = [
            ...
            ['name' => 'Rental Repairs & Maintenance', 'income_or_expense' => 'expense', 'sort_order' => 50],
            ['name' => 'Taxes', 'income_or_expense' => 'expense', 'sort_order' => 60],
        ];
        ...
        \App\Models\DescriptionCategoryRule::firstOrCreate(
            ...
            [
                'category_id' => TransactionCategory::where('name', 'Taxes')->first()->id,
                'is_active' => true,
